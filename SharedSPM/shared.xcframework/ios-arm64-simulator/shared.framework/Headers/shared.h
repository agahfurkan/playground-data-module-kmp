...
@class SharedKotlinArray<T>, SharedKotlinException, SharedKotlinIllegalStateException, SharedKotlinNothing, SharedKotlinRuntimeException, SharedKotlinThrowable, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule, SharedUser, SharedUserCompanion, UIViewController;
...
- (instancetype)initWithId:(int64_t)id name:(NSString *)name email:(NSString *)email __attribute__((swift_name("init(id:name:email:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedUserCompanion *companion __attribute__((swift_name("companion")));
- (SharedUser *)doCopyId:(int64_t)id name:(NSString *)name email:(NSString *)email __attribute__((swift_name("doCopy(id:name:email:)")));
...
*/
- (void)getUsersWithCompletionHandler:(void (^)(NSArray<SharedUser *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getUsers(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserService")))
@interface SharedUserService : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
